...
public class RequestHandler {
     ...
     * @param <T>
     */
    public synchronized static <T> void makeWebservice(final boolean flag, final Context context, int method, String url, final HashMap<String, String> param, final Class<T[]> aClass, final VolleyResponseListener listener) {
