    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle1) {
        ...
        btnbill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Fragment report = new Fragmentbills();
        ...
        btnreport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment report = new Fragmentreports();
...
//                }
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                makeCheckOutRequest();
                Log.v(TAG, " signatureView is Clicked : " + Utility.getEncoded64ImageStringFromBitmap(signatureView.getSignatureBitmap()));
            }
        });
        return view;
    }
    ...
    private void makeCheckOutRequest() {
        ...
        Log.d("hi", String.valueOf(signatureView.getPenSize()));
        ...
        if (radioGroupWorkingStatus.getCheckedRadioButtonId() == -1) {
            ...
            if (radioButtonText.equalsIgnoreCase("Collected")) {
                if (signatureView.getSignatureBitmap()==null) {
                    Toast.makeText(getActivity(), "Plz put Sign", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void makerequest(ArrayList<String> materialIds, ArrayList<String> materialQuantity, String radioButtonText) {
        ...
        param.put("sign", Utility.getEncoded64ImageStringFromBitmap(signatureView.getSignatureBitmap()));
        ...
        Log.v(TAG, "materialId :" + materialIds.toString().replaceAll("\\[|\\]", ""));
        Log.v(TAG, "quantity : " + materialQuantity.toString().replaceAll("\\[|\\]", ""));
        Log.v(TAG, "workStatus : " + radioButtonText);
        Log.v(TAG, "sign : " + Utility.getEncoded64ImageStringFromBitmap(signatureView.getSignatureBitmap()));
        Log.v(TAG, "reason : " + reason.getText().toString());
